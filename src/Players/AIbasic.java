...
public class AIbasic extends Player {
    ...
    List getVerticalStrs (String[][] board) {
        ...
        String[] col1 = new String[board.length];
        String[] col2 = new String[board.length];
        String[] col3 = new String[board.length];
        for (String[] strs : board) {
            col1[0] = strs[0]; col2[1] = strs[1]; col3[2] = strs[2];
        }
        setOfVerts.add(col1);
        setOfVerts.add(col2);
        setOfVerts.add(col3);
    ...
    List getDiagonalStrs (String[][] board) {
        ArrayList<String[]> setOfVerts = new ArrayList<String[]>(board.length);
        String[] diag1 = new String[board.length];
        String[] diag2 = new String[board.length];
        for (int i = 0; i < board.length; i++) {
            diag1[i] = board[i][i];
            diag1[i] = board[board.length-1-i][i];
        }
        setOfVerts.add(diag1); setOfVerts.add(diag2);
        return setOfVerts;
    }
